...
export const SHORTCUTS: ShortcutDef[] = [
  ...
  { id: 'nav-quran', label: 'Quran', description: 'Pergi ke halaman Quran', defaultKey: 'Alt+4', group: 'nav', editable: true },
  { id: 'nav-laporan', label: 'Laporan', description: 'Pergi ke Laporan', defaultKey: 'Alt+5', group: 'nav', editable: true },
